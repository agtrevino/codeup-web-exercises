...
// var brotherBearDaysRented = prompt("how many days will you rent The Brother Bear?");
// var HerculesDaysRented = prompt("how many days will you rent The Hercules?");
//
// var totalPrice = (parseInt(littleMermaidDaysRented) + parseInt(brotherBearDaysRented) + parseInt(HerculesDaysRented)) * pricePerDAy;
//
...
//
// var totalPay = parseInt(googleHoursWorked*googleHourlyPay) + parseInt(amazonHoursWorked*amazonHourlyPay) + parseInt(facebookHoursWorked*facebookHourlyPay);
...
//
// var offerCanBeApplied = ((numberOfItemsPurchased >= numberOfItemsForOffer) && offerNotExpired) || premiumMemberStatus && offerNotExpired ;
//
...
var acceptablePasswordLength = password.length => 5;
var acceptableUsernameLength = 20;
